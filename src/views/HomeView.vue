...
<template>
  ...
  <main class="bg-[#1E1E24] pt-20 mb-0 pb-0 w-full">
    <section class="flex">
      <div class="w-full lg:w-3/6 m-16 p-8">
        <h1 class="text-[#00FFAB] text-7xl" style="font-family: Archivo Black; letter-spacing: 0px">
          Hi. I'm Marcelo. <br />
          <span>A Developer.</span>
        </h1>
        <div class="mt-6 text-white bg-[#222831] p-6 rounded-3xl text-xl">
          <p>I'm a a passionate about programming, web development and technology.</p>
          <div>
            <p class="mt-2 text-xl text-[#2B7A78] font-bold">Technologies I use:</p>
            <TecnologiesList />
          </div>
        </div>
      </div>
      <div
        class="hidden lg:flex lg:justify-center lg:align-center lg:w-2/6 lg:h-full lg:mt-8 lg:p-8"
        lg=""
      >
        <img src="@/assets/images/foto_perfil_linkedin.jpg" class="flex rounded-full mw-5/6" />
      </div>
    </section>

    <div class="bg-[#00FFAB] text-[#222831] w-full h-1 mt-0" style="user-select: none">1</div>

    <section class="flex my-8">
      <div class="flex flex-col gap-4 text-center m-6 w-full">
        <h1 class="text-[#00FFAB] text-6xl" style="font-family: Archivo Black; letter-spacing: 0px">
          My projects so far.
        </h1>
        <p class="text-white text-xl">Making projects is my way of learning new things.</p>
      </div>
    </section>
    ...
    <section class="flex my-8">
      <div class="flex flex-col gap-4 text-center m-6 w-full">
        ...
        <p class="text-white text-xl">123</p>
      </div>
    </section>
  </main>
