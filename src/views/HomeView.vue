...
<template>
  ...
  <main class="mb-12 pb-0 w-full">
    <section class="flex justify-center css-selector">
      <div class="flex flex-col w-full lg:w-1/2 m-12 mt-24 justify-center align-center">
        ...
        <div class="mt-6 text-white bg-[#22283177] p-6 rounded-3xl text-xl">
  ...
  <footer class="bg-[#1e1e24] border-t border-gray-700">
...
<style scoped>
.css-selector {
  background: linear-gradient(197deg, #3bf1c2, #1a5848, #0c1412);
